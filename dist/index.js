...
function run() {
  ...
  const privateKey = getInput("ssh-private-key");
  if (!privateKey) {
    setFailed("The ssh-private-key argument is empty. Maybe the secret has not been configured, or you are using a wrong secret name in your workflow file.");
    return;
  }
  info(`Adding GitHub.com keys to ${homeSsh}/known_hosts`);
  import_fs2.default.mkdirSync(homeSsh, { recursive: true });
  import_fs2.default.appendFileSync(`${homeSsh}/known_hosts`, "\ngithub.com ssh-rsa \n");
  import_fs2.default.appendFileSync(`${homeSsh}/known_hosts`, "\ngithub.com ssh-dss \n");
  info("Starting ssh-agent");
  const authSock = getInput("ssh-auth-sock");
  let sshAgentOutput = "";
  if (authSock && authSock.length > 0) {
    sshAgentOutput = import_child_process.default.execFileSync("ssh-agent", ["-a", authSock]);
  } else {
    sshAgentOutput = import_child_process.default.execFileSync("ssh-agent");
  }
  ...
  info("Adding private key to agent");
  privateKey.split(/(?=-----BEGIN)/).forEach(function(key) {
    import_child_process.default.execSync("ssh-add -", { input: key.trim() + "\n" });
  });
  info("Keys added:");
  import_child_process.default.execSync("ssh-add -l", { stdio: "inherit" });
}
try {
  run();
} catch (error2) {
